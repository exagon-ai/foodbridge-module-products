...
- [Addendum 008 — Image Directory modal and mobile parity](./addendum-008-image-directory-modal-mobile-parity.md) — replaces the former image capture page with the supplied same-page Global/Local directory modal and completes functional mobile parity
- [Addendum 009 — Mobile live camera gallery](./addendum-009-mobile-live-camera-gallery.md) — adds the supplied camera-first mobile Image Gallery with live preview, capture controls, tags, photo progress and My Photos while preserving desktop directory import
